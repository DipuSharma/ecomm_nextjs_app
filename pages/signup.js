...
export default function SignUp() {
    ...
    async function handleSubmit() {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/admin-registration`, {
            method: "POST",
        ...
        if (res) {
            ...
            alert("User not registred successfully")
            router.push('/signup')
        }
    }
                    ...
                    <div className="px-10 pt-4 pb-8 rounded-3xl shadow-xl">
                        ...
                        <form>
                            <div className="relative">
                                ...
                                className="peer 
                                w-full px-0.5 border-0 
                                border-b-2 border-gray-300 
                                placeholder-transparent focus:ring-0 
                                focus:border-purple-600 focus:outline-none" 
                                placeholder="Please enter valid email @xyz.com" />
                                {/*Label  */}
                                <label htmlFor="email" className="absolute left-0 -top-5 
                                text-gray-600 text-sm transition-all 
                                peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 
                                peer-placeholder-shown:-top-0.5 peer-focus:-top-5 peer-focus:text-purple-600 peer-focus:text-sm">
                                    Email
                                    </label>
                            </div>
                            <div className="mt-10 relative">
                                ...
                                onChange={handleChange} 
                                className="peer w-full px-0.5 border-0 border-b-2 border-gray-300 
                                placeholder-transparent focus:ring-0 
                                focus:border-purple-600 font-bold 
                                focus:outline-none" placeholder="Password" />
                                {/*Label  */}
                                <label htmlFor="password" className="absolute left-0 -top-5 
                                text-gray-600 text-sm transition-all 
                                peer-placeholder-shown:text-base 
                                peer-placeholder-shown:text-gray-400 
                                peer-placeholder-shown:-top-0.5 peer-focus:-top-5 
                                peer-focus:text-purple-600 peer-focus:text-sm">Password</label>
                            </div>
                            <div className="mt-10 relative">
                                <input 
                                id="confirm_password"
                                ...
                                type="password" 
                                value={state.confirm_passowrd} 
                                onChange={handleChange} 
                                className="peer w-full 
                                px-0.5 border-0 
                                border-b-2 border-gray-300 
                                placeholder-transparent 
                                focus:ring-0 focus:border-purple-600 
                                font-bold focus:outline-none" 
                                placeholder="Confirm Password" />
                                {/*Label  */}
                                <label htmlFor="confirm_password" className="absolute 
                                left-0 -top-5 text-gray-600 text-sm 
                                transition-all peer-placeholder-shown:text-base 
                                peer-placeholder-shown:text-gray-400 
                                peer-placeholder-shown:-top-0.5 peer-focus:-top-5 
                                peer-focus:text-purple-600 peer-focus:text-sm">Confirm Password</label>
                            </div>
                            <button type="button" onClick={handleSubmit} className="w-full mt-14 py-2 text-lg text-white font-semibold text-center rounded-full bg-purple-500 transition-all hover:bg-purple-600 focus:outline-none">Sign up</button>
