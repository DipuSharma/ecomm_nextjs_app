    ...
    return (
        <div className="w-full md:py-20">
            <Wrapper>
                ...
                ">
                    <div className="text-[28px] md:text-[30px] mb-5 font-semibold
                    leading-tight">
                        Shopping Cart
                    </div>
                </div>
                ...
                <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
                    ...
                    <Link href="/" className="py-4 px-8 rounded-full bg-black text-white
                    text-lg font-medium transition-transform active:scale-95 mb-3
                    hover:opacity-75 mt-8">
                        Continue Shopping
                    </Link>
                </div>
                {/* This is empty cart view end */}
            </Wrapper>
        </div>
    )
}
