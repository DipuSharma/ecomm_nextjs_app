...
const RecentOrders = () => {
    return (
        <div className="w-full col-span-1 relative lg:h-[70vh] h-[50vh] m-auto p-4 border
        rounded-lg bg-white overflow-scroll">
            <h2>Recent Orders</h2>
            <ul>
                {data.map((order, id) => (
                    <li key={id} className="bg-gray-50 hover:bg-gray-100, rounded-lg my-3 p-2 flex items-center cursor-pointer">
                        ...
                        <div className="pl-4">
                            <p className="text-gray-800 font-bold"><span content="\20B9">&#8377;</span>{order.total}</p>
